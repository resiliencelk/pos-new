    ...
    <div class="row-container">
        ...
        <div id="right-column">
        	<div class="main-text-container">
                ...
                <a href="issuecheque.php" class="system-item-box"><img src="../images/Cheque/issuecheque.png" width="100%" style="border-radius:5px;"/></a>
                <a href="receivecheque.php" class="system-item-box"><img src="../images/Cheque/receivecheque.png" width="100%" style="border-radius:5px;"/></a>
              	</div>
            </div>
        </div>
    </div>
