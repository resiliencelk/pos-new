    ...
    <div class="row-container">
        ...
        <div id="right-column">
        	<div class="main-text-container">
                ...
                <a href="invoice.php" class="system-item-box"><img src="../images/invoice/sales.png" width="100%" style="border-radius:5px;"/></a>
                <a href="service-invoice.php" class="system-item-box"><img src="../images/invoice/service.png" width="100%" style="border-radius:5px;"/></a>
                <a href="quotationinvoice.php" class="system-item-box"><img src="../images/invoice/quotat.png" width="100%" style="border-radius:5px;"/></a>
                <a href="credit-invoice.php" class="system-item-box"><img src="../images/invoice/credit.png" width="100%" style="border-radius:5px;"/></a>
                <a href="view-invoice.php" class="system-item-box"><img src="../images/invoice/viewinvoice.png" width="100%" style="border-radius:5px;"/></a>
              	</div>
            </div>
        </div>
    </div>
