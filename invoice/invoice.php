...
<script language="javascript" type="text/javascript">
	...
	function cal_advance()
	{
		...
		var nettotal=0;
		var grandtotal=0;
		nettotal=parseInt(document.invoice.grandtotal.value);
		discounts=parseInt(document.invoice.advance.value);
		grandtotal=parseInt(nettotal)-parseInt(discounts);
		alert("Grand Total price :"+grandtotal+".00");
		document.invoice.balance.value=grandtotal+".00";
    			...
    			<!-- end of message row !-->
                            ...
                            <div class="row-container" style="border-bottom:1px dashed #CCCCCC;">
                                ...
                                <tr>
                                    ...
                                    <table width="100%" cellpadding="5px" cellspacing="0" border="1" bordercolor="#999999">
                                        ...
                                        ?>
                                        <tr>
                                            <td><a href="invoice.php?customerid=<?php echo $customerdata['customerid']; ?>&customername=<?php 
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        ...
                                        <table width="100%" cellpadding="5px" cellspacing="0" border="1" bordercolor="#999999">
                                            ...
                                            ?>
                                            <tr>
                                                <td><a href="invoice.php?catagory=<?php echo $typedata['type']; ?>"><?php echo $typedata['type']; ?></a></td>
                                            </tr>
                                            <?php
                                                }
                                            }
                                    ...
                                    <td  width="20%">
                                        ...
                                        <div id="openitems" class="modalDialog">
                                            ...
                                            <table width="100%" cellpadding="5px" cellspacing="0" border="1" bordercolor="#999999">
                                                ...
                                                ?>
                                                <tr>
                                                    <td><a href="invoice.php?itemid=<?php echo $itemdata['itemid']; ?>"><?php echo $itemdata['itemid']; ?></a></td>
                    ...
                    <div class="row-container" style="margin-top:20px;">
                        ...
                        <tr style="background:url(../images/table-bg.jpg); background-repeat:repeat-x; height:30px;">
                          ...
                          <th width="10%"><div class="table-heading">Serial No</div></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $invoiceditemdatas['serialnumber']; ?>
                            </td>
                            <td>
                        ...
                        <tr>
                          ...
                          <td align="right"><input type="text" name="advance" value="0" style="text-align:right; font-weight:bold;" onblur="cal_advance();"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td align="right"><input type="text" name="balance" value="0" style="text-align:right; font-weight:bold;" onblur=""/></td>
                        </tr>
                      </table>
