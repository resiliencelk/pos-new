    ...
    <div class="row-container">
        ...
        <div id="right-column">
        	<div class="main-text-container">
                ...
                <a href="order.php" class="system-item-box"><img src="../images/purchase/purchase.png" width="100%" style="border-radius:5px;"/></a>
                <a href="grn.php" class="system-item-box"><img src="../images/purchase/grn.png" width="100%" style="border-radius:5px;"/></a>
                <a href="return.php" class="system-item-box"><img src="../images/purchase/return.png" width="100%" style="border-radius:5px;"/></a>
              	</div>
            </div>
        </div>
    </div>
